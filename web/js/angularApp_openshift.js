            ...
            Facebook.getLoginStatus(function (response) {
                ...
                if (response.status == "connected") {
                    Facebook.api('/me', function (response) {
                        ...
                        $http.get('/recServlet?fbID=' + $rootScope.fbUserID).success(function (resp) {
...
//            }, 500, 1);
            function checkCoupon(coupon) {
                $http.get('/checkCoupon?deviceId=' + $rootScope.fbUserID + '&couponId=' + coupon.couponId).
...
//                            console.log($scope.deviceId);
            ...
            function redeemCoupon(coupon) {
                $http.get('/redeemCoupon?deviceId=' + $rootScope.fbUserID + '&couponId=' + coupon.couponId + '&tranToken=' + $scope.tranToken).
                        success(function (data) {
                            //console.log(data);
                        });
            }
            ...
            $rootScope.clickRedeem = function (coupon) {
                if ($rootScope.fbStatus == "connected") {
                    ...
                    if ($rootScope.redeemStatus == 2) {
                        redeemCoupon(coupon);
                        $window.location.replace("/index.html?" + coupon.couponId);
                    }
                } else {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope.toggle = function (fbUserID, offerID, catID, subCatID, index) {
                        if ($rootScope.fbStatus == "connected") {
                            ...
                            $http.get('/recordRating?fbID=' + fbUserID + '&offerID=' + offerID + '&catID=' + catID + '&subCatID=' + subCatID + '&rate=' + (index + 1)).success(function (resp) {
                            });
                        } else {
                            Facebook.login(function (response) {
                                if (response.status === 'connected') {
...
angular.module('dialogs.main', ['dialogs.services', 'ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
        ...
        .run(['$templateCache', '$interpolate', function ($templateCache, $interpolate) {
                ...
                $templateCache.put('/dialogs/confirm.html',
                        ...
                        '<a class="bs-btn-fb bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="facebook"  socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.offerID}}">' +
                        '</a>' +
                        '</div>' +
                        '<div class="bs-line-compress" ng-if="msg.couponId > 0">' +
                        '<a class="bs-btn-fb bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="facebook"  socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.couponId}}">' +
                        '</a>' +
                        '</div>' +
                        '</div>' +
                        //twitter
                        ...
                        '<div class="bs-col2 line-tablet">' +
                        '<div class="bs-line-compress" ng-if="msg.offerID > 0">' +
                        '<a class="bs-btn-twitter bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="twitter" socialshare-text="Check out this great deal from The Good Life® at {{msg.merchantName}} @ " socialshare-via="ahhahahah" socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.offerID}}"  socialshare-hashtags="TGLapp">' +
                        '</a>' +
                        '</div>' +
                        '<div class="bs-line-compress" ng-if="msg.couponId > 0">' +
                        '<a class="bs-btn-twitter bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="twitter" socialshare-text="Check out this great deal from The Good Life® at {{msg.merchantName}} @ " socialshare-via="ahhahahah" socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.couponId}}"  socialshare-hashtags="TGLapp">' +
                        '</a>' +
                        '</div>' +
                        '</div>' +
                        //google
                        ...
                        '<div class="bs-col2 line-tablet">' +
                        '<div class="bs-line-compress" ng-if="msg.offerID > 0">' +
                        '<a class="bs-btn-google bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="google+" socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.offerID}}">' +
                        '</a>' +
                        '</div>' +
                        '<div class="bs-line-compress" ng-if="msg.couponId > 0">' +
                        '<a class="bs-btn-google bs-btn-medium bs-center-content bs-radius bg-btn-share" socialshare="" socialshare-provider="google+" socialshare-url="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.couponId}}">' +
                        '</a>' +
                        '</div>' +
                        '</div>' + '</div>' +
                        //end social sharing
                        ...
                        '<div class="main-details">' +
                        '<br><br><input ng-if="msg.offerID > 0" type="text" class="linkCopyInput" ng-click="onTextClick($event)" value="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.offerID}}" title="This url is for sharing" readonly="readonly"/>' +
                        '<input ng-if="msg.couponId > 0" type="text" class="linkCopyInput" ng-click="onTextClick($event)" value="http://thegoodlife2015-jhgoh.rhcloud.com/index.html?{{msg.couponId}}" title="This url is for sharing" readonly="readonly"/>' +
                        '<p></p>' +
                        '</div>' + //maindetails
